"""
Django settings for boutqiue_ado project.
...
SECRET_KEY = 'django-insecure-_b((iub9sg)r2!rf^703t&9v#k+cmmkd=()1)w)bo^^+eh$6pj'
...
ROOT_URLCONF = 'boutqiue_ado.urls'
...
WSGI_APPLICATION = 'boutqiue_ado.wsgi.application'
